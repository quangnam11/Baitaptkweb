                            ...
                            <div class="grid__row">
                                ...
                                <div class="grid__column-2-4 catego">
                                    <a class="home-product-item" href="#">
                                        <div class="home-product-item__img"style=" background-image: url({{URL::to('public/uploads/product/'.$brand->product_image)}});" ></div>
                                        <h4 class="home-product-item__name">{{$brand->product_name}}</h4>
                                        <div class="home-product-item__price">
                                            <span class="home-product-item__price-old">{{$brand->product_price}}d</span>
                                            <span class="home-product-item__price-current">{{$brand->product_price*$brand->product_pricesale/100}}</span>
                                        </div>
                                        ...
                                        <div class="home-product-item__origin">
                                            <div class="home-product-item__brand">{{$brand->brand_name}}</div>
                                        ...
                                        <div class="home-product-item__favourite favou">
                                            ...
                                            <span>
                                            <?php
												if($brand->product_hot==0){
													echo 'Hot';
												}else if($brand->product_hot==1){
													echo 'Nổi Bật';
												}else if($brand->product_hot==2){
													echo 'Thường';
												}else if($brand->product_hot==3){
													echo 'Sale';
												}
											?>
                                            </span>
                                        ...
                                        <div class="home-product-item__sale-off ">
                                            <span class="home-product-item__sale-off-percent">{{$brand->product_pricesale}}%</span>

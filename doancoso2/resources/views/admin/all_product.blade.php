          ...
          <tr>
            ...
            <?php
                if($pro->product_hot==0){
                    echo 'Hot';
                }else if($pro->product_hot==1){
                    echo 'Nổi Bật';
                }else if($pro->product_hot==2){
                    echo 'Thường';
                }else if($pro->product_hot==3){
                    echo 'Sale';
                }
                ?>
            </td>
            
            <td>{{$pro->product_pricesale}}</td>
            ...
            <td>
              <a href="{{URL::to('/edit-product/'.$pro->product_id)}}" class="active" ui-toggle-class="" style="font-size:26px">
                <i class="fa fa-pencil-square-o text-success text-active"></i>
              </a> 
             
              <a onclick="return confirm('Bạn Muốn Xóa Sản Phẩm Này Không')" href="{{URL::to('/delete-product/'.$pro->product_id)}}" class="active " ui-toggle-class="" style="font-size:26px">
